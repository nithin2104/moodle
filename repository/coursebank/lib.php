...
/**
 * repository_coursebank plugin implementation
 *
...
/**
 * Summary of repository_coursebank
 */
class repository_coursebank extends repository {
    ...
    public function get_listing($encodedpath = '', $page = '') {
        ...
        if ($browser = \repository_coursebank\helper::get_coursebank_browser($context)) {
            $manageurl = new moodle_url('/local/coursebank/index.php', ['contextid' => $context->id]);
            $canaccesscontent = has_capability('local/coursebank:access', $context);
    ...
    public function file_is_accessible($source) {
        ...
        if (!empty($contextid)) {
            ...
            $browser = \repository_coursebank\helper::get_coursebank_browser($context);
    ...
    public function search($search, $page = 0) {
        $ret = [];
        $ret['nologin'] = true;
        $ret['list'] = \repository_coursebank\coursebank_search::get_search_contents($search);
