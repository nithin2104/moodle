 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class coursebank_browser_context_coursecat extends coursebank_browser {
    ...
    public function can_access_content(): bool {
        ...
        if (has_capability('repository/coursebank:accesscoursecategorycontent', $this->context)) {
            return true;
        }
        ...
        return $canaccesschildcontent && has_capability('repository/coursebank:accessgeneralcontent',
            $this->context);
    }
}
