...
/**
 * The configuration for theme_logintheme theme is defined here.
 *
...
$THEME->scss = function($theme) {
    return theme_logintheme_get_main_scss_content($theme);
};
