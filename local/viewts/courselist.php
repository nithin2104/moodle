...
$PAGE->set_url(new moodle_url('/local/viewts/courselist.php'));
$PAGE->set_title(get_string('pluginname', 'local_viewts'));
$PAGE->set_heading(get_string('crheading', 'local_viewts'));
...
$thingnode = $previewnode->add(
    get_string('viewcourse', 'local_viewts'),
    new moodle_url('/local/viewts/courselist.php'),
);
...
echo $OUTPUT->header();
echo $OUTPUT->render_from_template('local_viewts/courses', $tempcontext);
echo $OUTPUT->footer();