...
$PAGE->requires->js_call_amd('local_coursebank/upload', 'init', ['contextid' => $contextid]);

echo $OUTPUT->header();
echo $OUTPUT->heading($title, 2);
$renderable = new \local_coursebank\output\viewcontent($contextid);
$output = $PAGE->get_renderer('local_coursebank');
